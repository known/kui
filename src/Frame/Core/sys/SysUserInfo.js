function SysUserInfo() {
    ...
    this.render = function (dom) {
        ...
        var info = $('<div style="padding:10px;">').appendTo(left);
        $('<div class="center" style="padding:20px;">')
            .append('<img id="userAvatar" class="circle" src="' + baseUrl + '/static/img/face1.png" />')
            .appendTo(info);
        $('<div class="info-item">')
        ...
        $('<div class="info-item">')
            ...
            .appendTo(info);
        $('<div id="userNote" class="info-item">').appendTo(info);
...
function SysUserBaseInfo() {
    ...
    var form = new Form('UserInfo', {
        ...
        setData: function (e) {
            $('#userAvatar').attr('src', baseUrl + e.data.AvatarUrl);
            top.Admin.setUserAvatar(e.data.AvatarUrl);
        ...
        onSaving: function (data) {
            ...
            data.AvatarUrl = '/static/img/face' + face + '.png';
        },
        toolbar: [{
...
function SysUserMessage() {
    ...
    this.render = function () {
        ...
        var left = $('<div class="um-box-left">').appendTo(elem);
        _createButtons(left, _leftButtons);

        _right = $('<div class="um-box-right">').appendTo(elem);
        return elem;
    }
    ...
    function _showGrid(type) {
        ...
        var grid = new Grid('UserMessage', {
            ...
            columns: [
                ...
                { title: '时间', field: 'CreateTime', width: '140px', placeholder: 'yyyy-MM-dd HH:mm:ss' }
            ]
        });
