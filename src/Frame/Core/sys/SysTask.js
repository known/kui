function SysTask() {
    ...
    var view = new View('SysTask', {
        ...
        columns: [
            ...
            { title: Language.BeginTime, field: 'BeginTime', width: '140px', placeholder: 'yyyy-MM-dd HH:mm:ss' },
            { title: Language.EndTime, field: 'EndTime', width: '140px', placeholder: 'yyyy-MM-dd HH:mm:ss' },
            {
