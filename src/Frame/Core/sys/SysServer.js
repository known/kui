function SysServer() {
    ...
    var view = new View('SysServer', {
        ...
        columns: [
            ...
            { title: Language.UpdateTime, field: 'UpdateTime', width: '140px', placeholder: 'yyyy-MM-dd HH:mm:ss' },
            { title: Language.StartTime, field: 'CreateTime', width: '140px', placeholder: 'yyyy-MM-dd HH:mm:ss' },
            {
